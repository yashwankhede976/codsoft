...
Generate image output from the metrics CSV:

```powershell
C:\Users\umesh\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe src\generate_report_image.py
```
...
Image output: `reports/model_comparison.png`
